...
# Load the JSON file
json_path = script_dir.parent / "data/template_cartoon_drawing_v1.json"
images_dir = script_dir.parent / "data/cartoon_drawing"
output_zip = script_dir.parent / "data/training_data_cartoon_drawing.zip"
